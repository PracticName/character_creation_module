...
class Character:
    ...
    RANGE_VALUE_ATTACK = (1, 3)  # Константа для диапазона очков урона.
    RANGE_VALUE_DEFENCE = (1, 5)  # Диапазон значения защиты.
    SPECIAL_BUFF = 15  # Значение очков урона.
...
def start_training(character):
    ...
    cmd: str = None
    while cmd != 'skip':
        cmd = input('Введи команду для тренировки '
                    'или введите "skip" для её завершения')
        if cmd == 'attack' or 'defence' or 'special':
            comands[cmd]
