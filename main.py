"""A module for creating a character.
Functions:
    attack(str, str) -> str
    defence(str, str) -> str
    special(str, str) -> str
    start_training(str, str) -> str
    choice_char_class() -> str
"""
...
def attack(char_name: str, char_class: str) -> str:
    """Return the damage done to the enemy."""
...
def special(char_name: str, char_class: str) -> str:
    """Return a special skill of the character."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Choosing the name and type of character."""
    approve_choice: str = ''
    char_class: str = ''
